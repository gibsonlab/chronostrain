...
#
# # ============= CONSTANTS
# if cfg.engine_cfg.default_dtype not in dtype_conversion:
#     raise RuntimeError(f"Can't translate torch dtype `{cfg.engine_cfg.default_dtype}` to numba dtype.")
#
# _DTYPE = dtype_conversion[cfg.engine_cfg.default_dtype]
#
#
