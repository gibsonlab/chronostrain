...
#     """
#     Applies a linear transformation to the incoming read_frags: :math:`y = xA + b`.
...
#         )
#
#         # self.radial_network = BatchLinear(num_times, num_times, num_strains, device=cfg.torch_cfg.device, dtype=cfg.torch_cfg.default_dtype)
