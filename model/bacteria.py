...
class Population:
    def __init__(self, strains):
        """
        :param strains: an array of Strain instances.
        """
    ...
    def get_fragment_space(self, window_size):
        """
        Get all fragments, lazy instantiation
        """
        if self.fragment_space is None:
            self.fragment_space = None  # TODO
        return self.fragment_space
