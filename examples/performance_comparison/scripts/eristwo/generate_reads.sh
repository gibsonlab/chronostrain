...
do
	...
	do
		...
		do
			...
			cat <<- EOFDOC > $LSF_PATH
#BSUB -J readgen
#BSUB -o ${READGEN_LSF_OUTPUT_DIR}/readgen_reads_${n_reads}_qs_${quality_shift}_trial_${trial}_-%J.out
#BSUB -e ${READGEN_LSF_OUTPUT_DIR}/readgen_reads_${n_reads}_qs_${quality_shift}_trial_${trial}_-%J.err
