...
export SETTINGS_PATH="${BASE_DIR}/scripts/multi-run/settings.sh"
...
export LSF_FILTER_QUEUE="normal"
export LSF_FILTER_MEM=2000
export LSF_FILTER_N_CORES=1
...
export FILTER_LSF_DIR="${LSF_DIR}/filter"
export FILTER_LSF_OUTPUT_DIR="${FILTER_LSF_DIR}/output"
