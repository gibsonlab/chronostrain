...
cd ${EFAECALIS_CHRONO_99_99PCT_MIRROR_REF_DIR}
echo "[**] Aligning fwd+rev reads"
n_colors=$(cat "${EFAECALIS_CHRONO_99_99PCT_MIRROR_CLUSTER}" | wc -l)
aln_and_compress ${strain_fq_1} ${strain_fq_2} ${strain_aln_1} ${strain_aln_2} ${EFAECALIS_CHRONO_99_99PCT_MIRROR_REF_INDEX} ${n_colors} ${strain_outdir}/tmp
...
mSWEEP \
  ...
  -i ${EFAECALIS_CHRONO_99_99PCT_MIRROR_CLUSTER} \
  --bin-reads \
