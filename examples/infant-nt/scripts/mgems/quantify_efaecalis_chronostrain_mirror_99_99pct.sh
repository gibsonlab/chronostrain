...
aln_and_compress ${strain_fq_1} ${strain_fq_2} ${strain_aln_1} ${strain_aln_2} ${EFAECALIS_CHRONO_99_99PCT_MIRROR_REF_INDEX} ${EFAECALIS_CHRONO_99_99PCT_N_COLORS} ${strain_outdir}/tmp
